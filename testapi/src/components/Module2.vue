<template>
  <div class="container w-75 pt-3">
    <div class="list row">
      <div class="col">
        <h4 class="pb-3">
          Listes des entreprises à fort potentiel d'embauche se trouvant à Paris ou Marseille travaillant dans le secteur
          Informatique
        </h4>
        <ul class="list-group" id="tutorials-list">
          <li
              class="list-group-item"
              :class="{ active: index === indexCourant }"
      ...
      <div class="col-md-12 pt-2 ">
        <b-pagination
            v-model="page"
            :total-rows="nbEntreprises"
            :per-page="nbEntreprisesParPage"
            prev-text="Prev"
            next-text="Next"
    ...
    retrieveEntreprises(){
      axios
          ...
          .then((reponse) => {
            ...
            this.nbEntreprises = reponse.data.companies_count;
          }).catch((reason) => {
